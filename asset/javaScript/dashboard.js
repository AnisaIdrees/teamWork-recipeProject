...
//   if (profileContainer && userManagementContainer && profileBtn && userManagementBtn && favContainer) {
//       // Profile Button Click Event
//       profileBtn.addEventListener("click", () => {
//           profileContainer.style.display = "block"; // Show Profile
//           userManagementContainer.style.display = "none"; // Hide User Management
...
//           userManagementContainer.style.display = "block"; // Show User Management
...
document.getElementById("signOut")?.addEventListener("click", async () => {
  try {
    ...
    if (result.isConfirmed) {
      ...
      window.location.href = "/Source/MainHomePage.html";
    }
  } catch (error) {
...
// /// updat admin profile //////////////////////////////////////////////////////////////////
// ✅ Fetch Profile Data from Firestore When User Logs In
...
onAuthStateChanged(auth, (user) => {
  if (user) {
    ...
    // ✅ Attach Upload Button Event Listener
...
/////////////////////favourite graph
// document.addEventListener("DOMContentLoaded", function () {
//   const pieCtx = document.getElementById("favoritesPieChart").getContext("2d");
//   const barCtx = document.getElementById("favoritesBarChart").getContext("2d");

//   // ✅ Dummy Data (Recipe Name & Favorite Count, up to 20)
//   const recipeData = {
//     "Pizza": Math.floor(Math.random() * 20) + 1,
//     "Pasta": Math.floor(Math.random() * 20) + 1,
//     "Biryani": Math.floor(Math.random() * 20) + 1,
//     "Burger": Math.floor(Math.random() * 20) + 1,
//     "Tacos": Math.floor(Math.random() * 20) + 1
//   };
